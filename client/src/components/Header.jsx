...
const Header = () => {
  ...
  return (
    ...
    >
      ...
      >
        <p>Best way to transform words into art</p>
      ...
      <motion.button
        ...
        className="sm:text-lg text-white bg-pink-700 w-auto mt-8 px-12 py-2.5 flex items-center gap-2 rounded-full cursor-pointer"
