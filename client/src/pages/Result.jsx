...
const Result = () => {
  ...
  const onSubmitHandler = async (e) => {
    ...
    console.log("Prompt being sent:", input); 
    ...
    if (input.trim()) {
      ...
      console.log("Input was empty or whitespace, skipping request.");
    }
    setLoading(false);
  };
    ...
    >
      ...
      {!isImageLoaded && (
        <div className="flex w-full max-w-xl bg-neutral-500 text-white text-sm p-0.5 mt-10 rounded-full">
          ...
          <button
            type="submit"
            className="bg-pink-700 px-10 sm:px-16 py-3 rounded-full cursor-pointer"
          >
            Generate
          </button>
        </div>
